  ...
  sections: [
    {
      ...
      items: [
        ...
        { name: 'Diagnostic Services', description: 'Diagnostic services include a wide range of medical tests and procedures designed to evaluate a patient’s health. Hospitals typically house specialized units equipped with advanced technology and staffed by trained professionals.', imageUrl: '/images/DiagnosticServices.jpeg' },
        { name: '24 Hours Sample Collection', description: '24-Hours Sample Collection is a hospital diagnostic service that allows patients to submit medical samples at any time of the day or night. This round-the-clock availability is especially important for emergencies, critical care patients, and tests that must be performed without delay.', imageUrl: '/images/SampleCollection.jpeg' },
        { name: '24 Hours Centralised Oxygen', description: '24-Hours Centralised Oxygen is a vital hospital system that delivers a continuous supply of medical oxygen to patients across different departments such as the ICU, emergency room, operation theatre, and general wards. Instead of using individual oxygen cylinders for each patient, hospitals rely on a centralized pipeline system that operates 24 hours a day to ensure safety and uninterrupted care.', imageUrl: '/images/CentralisedOxygen.jpeg' },
        { name: 'Woman Care', description: 'Woman Care (also called women’s healthcare services) is a specialized hospital department dedicated to the health and well-being of women at every stage of life. It focuses on prevention, diagnosis, maternity care, and treatment of conditions related to the female reproductive system.', imageUrl: '/images/WomanCare.jpg' },
        { name: 'Thyroid Care', description: 'Thyroid Care is a specialized medical service focused on diagnosing, treating, and managing disorders of the thyroid gland — a small, butterfly-shaped gland located in the neck that regulates metabolism, energy levels, and hormone balance.', imageUrl: '/images/ThyroidCare.jpeg' },
        { name: 'Growth Monitoring', description: 'Growth Monitoring is a healthcare service that regularly measures a child’s physical development to ensure they are growing in a healthy and expected way. Doctors track important indicators such as height, weight, and head circumference to identify potential health or nutritional concerns early.', imageUrl: '/images/GrowthMonitoring.jpeg' },
        { name: 'Bandaging', description: 'Bandaging is a basic but essential medical service used to protect wounds, control bleeding, reduce swelling, and support injured body parts. It plays an important role in preventing infection and helping the body heal faster after injuries or surgical procedures.', imageUrl: '/images/Bandaging.webp' },
        { name: 'De-Worming', description: 'De-worming is a preventive and therapeutic healthcare service that removes parasitic worms from the body using safe and effective medications. It is especially important for children but is recommended for adults as well in areas where worm infections are common.', imageUrl: '/images/DeWorming.jpeg' },
        { name: '24 Hours Emergency Service', description: '24 Hours Emergency Service is a critical hospital facility that provides immediate medical care to patients suffering from serious injuries, sudden illnesses, or life-threatening conditions. This department operates day and night to ensure that expert medical help is always available when every second counts.', imageUrl: '/images/Open24x7.jpg' },
